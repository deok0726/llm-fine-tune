...
def insight_sns(path):
    with open("/svc/project/genaipilot/fine-tune/output/sns_8b_insight.txt", 'w') as f:
...
def insight_news(path):
    with open("/svc/project/genaipilot/fine-tune/output/news_8b_insight.txt", 'w') as f:
        document_text = read_text_file(path)
        template = """
                # 역할
...
if __name__ == "__main__":
    ...
    # insight_sns('/svc/project/genaipilot/fine-tune/output/sns_8b.txt')
    # insight_news('/svc/project/genaipilot/fine-tune/output/news_8b.txt')